...
class Solver():
    def __init__(self, model, cfg):
        ...
        self.optim = optim.Adam(
            ...
            cfg.lr)
        #self.optim= nn.DataParallel(self.optim, device_ids=[0,1]) #tcw
    ...
    def fit(self):
        cfg = self.cfg
        refiner = nn.DataParallel(self.refiner, device_ids=range(cfg.num_gpu)) #tcw
        #refiner = nn.parallel.data_parallel(self.refiner, [0,1]) #tcw
